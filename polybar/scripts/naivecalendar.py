...
NOTES_DATE_FORMAT = "%m-%d-%Y" #: strftime format, contains at least %d and month (%b, %m...)  + year (%Y...) identifier
...
TODAY_HEAD_NUMB_SIZE = "x-large" #: 'xx-small', 'x-small', 'small', 'medium', 'large', 'x-large', 'xx-large', see pango markup language spec
TODAY_HEAD_NUMB_RISE = 10000 #: The vertical displacement from the baseline, in ten thousandths of an em, see pango markup language spec
TODAY_HEAD_NAME_SIZE = "x-large" #: 'xx-small', 'x-small', 'small', 'medium', 'large', 'x-large', 'xx-large', see pango markup language spec
TODAY_HEAD_NAME_RISE = 10000 #: The vertical displacement from the baseline, in ten thousandths of an em, see pango markup language spec
...
def first_time_init():
    ...
    if not os.path.exists(NOTES_PATH):
        os.mkdir(NOTES_PATH)
        display_help(head_txt="Welcome to Calendar Notes")
