...
[<u>contains</u>](https://github.com/MDBrodskiy/i3DotFiles/tree/master/mutt): **neomuttrc**, multiple *empty* account configurations, **gpg**.**rc**, **primary** signature, **aliases**, **oauth2** script, alternative content type **templates**, **vim-keybindings.rc** & **powerline** colors and configurations
